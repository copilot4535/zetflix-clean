...
import com.lagradost.cloudstream3.ui.movie.HomeFragment
import com.lagradost.cloudstream3.ui.movie.HomeFragment.Companion.bindChips
import com.lagradost.cloudstream3.ui.movie.HomeFragment.Companion.currentSpan
import com.lagradost.cloudstream3.ui.movie.HomeFragment.Companion.loadHomepageList
import com.lagradost.cloudstream3.ui.movie.HomeFragment.Companion.updateChips
    ...
    override fun onBindingCreated(
        ...
        lifecycleScope.launch {
            val providers = withContext(Dispatchers.IO) {
                DataStoreHelper.searchPreferenceProviders.toMutableSet()
            }
            val tags = withContext(Dispatchers.IO) {
                DataStoreHelper.searchPreferenceTags.toMutableList()
            }
            selectedApis = providers
            selectedSearchTypes = tags
        }
