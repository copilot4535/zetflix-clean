...
class SettingsFragment : BaseFragment<FragmentSettingsUnifiedBinding>(
    ...
    private fun setupAccountSection(binding: FragmentSettingsUnifiedBinding) {
    ...
    private fun loadUserData(binding: FragmentSettingsUnifiedBinding) {
        ...
        ioSafe {
            try {
                ...
                main {
                    val header = binding.rowAccountHeader
