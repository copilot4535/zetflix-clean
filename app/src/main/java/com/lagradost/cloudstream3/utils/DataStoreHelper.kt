...
const val LIVESTREAM_CACHE_KEY = "livestream_cache"
...
object DataStoreHelper {
    ...
    fun cacheHomeData(data: Map<String, BaseHomeViewModel.ExpandableHomepageList>) {
    ...
    fun getCachedHomeData(): Map<String, BaseHomeViewModel.ExpandableHomepageList>? {
